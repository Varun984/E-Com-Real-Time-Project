...
conf_file_path = "C:\Users\vishn\OneDrive\Desktop\ecom-real-time_project\kafka_2.13-3.6.1/realtime_data_processing/"
conf_file_name = conf_file_path + "abc.env"
...
def save_to_mysql_table(current_df, epoc_id, mysql_table_name):
    ...
    current_df.write.jdbc(url = mysql_jdbc_url,table = mysql_table_name,mode = 'append',properties = db_properties)
...
if __name__ == "__main__":
    ...
    # Streaming DataFrame that reads from test-topic
    orders_df = spark \
        .readStream \
        .format("kafka") \
